        ...
        <div className={styles.inner}>
            ...
            <div className={styles.div2}>
                <div className={styles.div2O}>
                    <div><img src="../L1.png" height={180} width={200}/></div>
                    <div>Features</div>
                </div>
                <div className={styles.div2O}>
                    <div><img src="../L2.png" height={180} width={200}/></div>
                    <div>Template Gallery</div>
                </div>
                <div className={styles.div2O}>
                    <div><img src="../L3.png" height={180} width={200}/></div>
                    <div>Productivity Quiz</div>
                </div>
                <div className={styles.div2O}>
                    <div><img src="../L4.png"height={180} width={200}/></div>
                    <div>Extension Gallery</div>
                </div>
                <div className={styles.div2O}>
                    <div><img src="../L5.png"height={180} width={200}/></div>
